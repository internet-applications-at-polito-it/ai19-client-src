...
export class AppComponent {
  ...
  applyFilter(filterValue: string) {
    ...
    this.dataSource = HEROES_DATA.filter(
      x => x.name.match(filterValue)
    );
  }
